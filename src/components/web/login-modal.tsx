...
import { loginWithDiscord, loginWithGithub, loginWithGoogle } from "@/lib/actions/auth";
...
function DiscordSVG(props: SVGProps<SVGSVGElement>) {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 256 256"
          ...
          <div className="flex flex-col gap-3">
            ...
            <form action={loginWithDiscord}>
              ...
              >
                ...
                <span className="flex-1">Tiếp tục với Discord</span>
              </Button>
            </form>
